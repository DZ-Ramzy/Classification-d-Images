...
def nettoyer_composantes(img):
    ...
    # On ne prend que les composantes ayant une largeur supérieur à 300 pixels
    # On part du principe qu'une image ne contient pas plus de 35 marches, donc si on a plus de composantes,
    # on élimine les composantes trop fines et trop longues.
...
def calculer_composantes_connxes(img):
    # Fonction qui permet de calculer le nombre de marches à l'aide des composantes connexes rectangulaires.
    # Utilisation de sobel pour détecter les bords horizontaux seulement
    # Ouverture pour supprimer les petites composantes connexes qui ne nous intéressent pas
    # Double érosion pour bien néttoyer l'image
